<?php 
  ...
  if (isset($_POST) && !empty($_POST)){
    ...
    // move_uploaded_file(アップロードしたいファイル、サーバーのどこにどういう名前でアップロードするか指定 )
    move_uploaded_file($_FILES['picture_path']['tmp_name'],'../picture_path/'.$picture_name);

    // SESSION変数に入力された値を保存（どこの画面からでも利用できる！）
        ...
        <form method="post" action="" class="form-horizontal" role="form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <p class="error">* パッスワードは4文字以上を入力してください。</p>
              <?php } ?>
            </div>
          </div>
          <!-- プロフィール写真 -->
