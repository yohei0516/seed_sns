...
// session_start();
  ...
  if (isset($_POST) && !empty($_POST)){
    ...
    if (!isset($error)){
      ...
      // 1以下のイレギュラーの数字が入ってきた時、ページ番号を強制的に1とする
  ...
  if (isset($_SESSION["id"])){
    ...
    // ログインしている人の情報を取得
      ...
      $sql = "SELECT `tweets`.*,`members`.`nick_name`,`members`.`picture_path` 
              FROM `tweets` INNER JOiN `members` ON `tweets`.`member_id` = `members`.`member_id` 
              WHERE `delete_flag`= 0 ORDER BY `tweets`.`modified` DESC LIMIT ".$start.",".$page_row;
  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right"><li><a href="logout.php">ログアウト</a></li></ul>
      </div>
      <!-- /.navbar-collapse -->
    </div>
      <!-- /.container-fluid -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8 content-margin-top">
        <div class="mag_header">
          <a href="follow.php">Followers<span class="badge badge-pill badge-default"><?php echo $follower["cnt"]; ?></span></a> 
          <a href="following.php">Following<span class="badge badge-pill badge-default"><?php echo $following["cnt"]; ?></span></a>
        </div> 
        <?php  
